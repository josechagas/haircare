...
struct R: Rswift.Validatable {
  ...
  struct file {
    ...
    static let productsByCategoryJson = Rswift.FileResource(bundle: R.hostingBundle, name: "productsByCategory", pathExtension: "json")

    /// `bundle.url(forResource: "productsByCategory", withExtension: "json")`
    static func productsByCategoryJson(_: Void = ()) -> Foundation.URL? {
      let fileResource = R.file.productsByCategoryJson
